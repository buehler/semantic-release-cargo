 ...
 * @property {Boolean?} allFeatures
 * @property {Array<string>?} publishArgs additional arguments for the publish call.
 */
 ...
 */
module.exports = async ({ executable, allFeatures = false, publishArgs = [] }, { logger }) => {
